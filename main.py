...
import plots
import predict
st.set_page_config(page_title ='Car Price Prediction', page_icon = '🚗', layout = 'centered', initial_sidebar_state = 'auto')
...
pages_dict = {'Home': home, 'View Data': data, 'Plots': plots, 'Predict': predict}
